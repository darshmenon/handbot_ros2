...
#include "handbot_mtc_pick_place_demo/cluster_extraction.h"
#include "handbot_mtc_pick_place_demo/normals_curvature_and_rsd_estimation.h"
#include "handbot_mtc_pick_place_demo/object_segmentation.h"
#include "handbot_mtc_pick_place_demo/plane_segmentation.h"
#include <handbot_interfaces/srv/get_planning_scene.hpp>
...
class GetPlanningSceneServer : public rclcpp::Node {
 ...
 private:
  ...
  // Service
  rclcpp::Service<handbot_interfaces::srv::GetPlanningScene>::SharedPtr service;
  ...
  void createService() {
    ...
    service = this->create_service<handbot_interfaces::srv::GetPlanningScene>(
      "get_planning_scene_handbot",
   ...
   **********************************************************************************/
  void handleService(
      const std::shared_ptr<handbot_interfaces::srv::GetPlanningScene::Request> request,
      std::shared_ptr<handbot_interfaces::srv::GetPlanningScene::Response> response) {
