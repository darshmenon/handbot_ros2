...
trajectory execution, motion planning, and robot control specifically for the handbot platform.
...
def generate_launch_description():
    ...
    package_name_moveit_config = 'handbot_moveit_config'
    package_name_mtc_pick_place_demo = 'handbot_mtc_pick_place_demo'
    ...
    name="execute",
    default_value="true",  # Ensure execution is enabled
    description="Enable execution of the planned task"
)
    ...
    def configure_setup(context):
        ...
        mtc_demo_node = Node(
            package="handbot_mtc_pick_place_demo",
            executable=exe,
            output="screen",
            parameters=[
                  {'execute': True},
