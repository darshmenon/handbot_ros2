#!/usr/bin/env python3
"""
Launch RViz visualization for the handbot robot.

This launch file sets up the complete visualization environment for the handbot robot,
...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/handbot_ros2/handbot_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/handbot_moveit_config/share/handbot_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='handbot_100',
...
def generate_launch_description():
    """Generate the launch description for the handbot robot visualization.

    This function sets up all necessary nodes and parameters for visualizing
    the handbot robot in RViz, including:
    ...
    """
    # Define filenames
    urdf_package = 'handbot_description'
    urdf_filename = 'handbot_100.urdf.xacro'
    rviz_config_filename = 'handbot_100_description.rviz'
