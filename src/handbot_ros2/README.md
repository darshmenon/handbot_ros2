...
## Overview
This repository contains ROS 2 packages for simulating and controlling the handbot robotic arm using ROS 2 Control and MoveIt 2. It provides support for Gazebo simulation and visualization in RViz. Gazebo simulation also includes simulated 3D point cloud data from the depth camera (RGBD) sensor plugin for vision.
...
## Features
- Gazebo simulation of the handbot robotic arm
...
This guide will take you through the entire process of setting up and understanding the handbot_ros2 project.

![3D Point Cloud RViz](https://automaticaddison.com/wp-content/uploads/2024/12/800_3d-point-cloud.jpg)

![handbot100_rviz](./handbot_description/urdf/handbot100_rviz.png)
