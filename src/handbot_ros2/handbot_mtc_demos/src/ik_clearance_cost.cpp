 ...
 *
 * This program sets up a motion planning task for a handbot_280 robot arm using MoveIt Task Constructor.
...
int main(int argc, char** argv) {
  ...
  // Load the robot model (handbot_280)
  t.loadRobotModel(node);
  assert(t.getRobotModel()->getName() == "handbot_280");
